...
const (
	...
	ReasonCapQemuBinaryPresent             = "CAP_QEMU_BINARY_PRESENT"
	ReasonCapQemuBinaryMissing             = "CAP_QEMU_BINARY_MISSING"
	ReasonCapQemuUnsupportedArch           = "CAP_QEMU_UNSUPPORTED_ARCH"
